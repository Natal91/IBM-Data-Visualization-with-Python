...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('Vehicle_Type', 'unenployment_rate')[Automobile_Sales].mean()
        R_chart4 = dcc.Graph(figure=px.bar(unemp_data,
        x='Unemployment rate per Vehicle Type',
        y='Average Automobile Sales',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x="Year", y="Automobile_Sales", title="Yearly Report Statistics"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata, x="Month", y="Average Sales",title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
